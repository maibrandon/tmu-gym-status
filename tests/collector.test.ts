...
it('uses only matching Wednesday data and leaves missing buckets unavailable',async()=>{
 ...
 expect(data.facilities[0].alternatives.map((b: {percentage:number}) => b.percentage)).toEqual([65]);
